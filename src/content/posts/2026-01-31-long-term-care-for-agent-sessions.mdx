...
One practical way to see Tapes in action is through [OpenClaw](https://tapes.dev/guides/openclaw/), which provides remote development environments that integrate seamlessly with agent workflows.

<img src="https://res.cloudinary.com/bdougie/image/upload/v1769875192/blog/op.png" alt="OpenClaw integration with Tapes" width="600" />

OpenClaw uses Tapes as a proxy to capture all LLM interactions happening in your development environment. This means every agent conversation, every code generation session, every debugging interaction gets preserved automatically.
