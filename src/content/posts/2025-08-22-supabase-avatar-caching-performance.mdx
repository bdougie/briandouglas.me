...
description: "Discover how implementing a Supabase-based avatar caching strategy dramatically improved our Pull Request Contributions chart performance by reducing load times and eliminating redundant GitHub API calls."
date: 2025-08-22
...
<OptimizedImage src="https://res.cloudinary.com/bdougie/image/upload/v1761006255/blog/pr-cached_wghosh.gif" alt="pr cached example" />
