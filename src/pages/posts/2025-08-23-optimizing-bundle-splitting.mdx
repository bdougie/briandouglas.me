...
![Performance metrics showing improved LCP from 5.9s to 4.1s](https://res.cloudinary.com/bdougie/image/upload/f_auto,q_auto/blog/performance-metrics-bundle-optimization)
